...
describe("portable contracts", () => {
  ...
  it("ignores legacy screen-context preferences", () => {
    const preferences = mergePreferences({ screenContextEnabled: true, imageInputOverrides: { "legacy:model": true } });
    expect(preferences).not.toHaveProperty("screenContextEnabled");
    expect(preferences).not.toHaveProperty("imageInputOverrides");
  });
